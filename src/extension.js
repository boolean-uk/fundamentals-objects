...
// 3. Book ISBN 13 should be 978-0132350884
book.isbn.isbn13 = isbn13

// 4. Book should not contain the asin key - it should be deleted
delete book.isbn.asin

// 5. Book should not contain the dimensions key - it should be deleted
delete book.dimensions

// 6. Book category should be Programming
book.category = 'Programming'

// 7. Book pages should be 464
book.pages = 464
...
// 1. The price of apples should be updated to 2
basket.items[0].price = 2

// 2. 4 oranges priced at 0.75 should be added to the end of the items list
