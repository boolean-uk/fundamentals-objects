...
// Change category to Programming
book.category = 'Programming'

// Delete the book dimensions key and asin key
...
// Update the price of apples to 2
basket.items[0].price = 2

// Add 4 oranges priced at 0.75 to the items list
