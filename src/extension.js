...
// 5. Update price of apples to 2
basket.items[0].price += 1
...
// 9. Book ISBN 13 should be 978-0132350884
book.isbn.isbn13 = isbn13

// 10. Book should not contain the dimensions key - it should be deleted
delete book.dimensions

// 11. Book should not contain the asin key - it should be deleted
