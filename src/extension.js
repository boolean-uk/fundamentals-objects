...
// 3. Set this variable to the length of the baskets
// voucher codes array - using the basket object
const numberOfVoucherCodes = basket.voucherCodes.length

// 4. Set this variable to the first element in of
// the baskets voucher codes array - using the basket object
const firstVoucherCode = basket.voucherCodes[0]

// Fixing based on test failure messages
